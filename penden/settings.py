...
# FIXED: Cache configuration for Django Ratelimit
# Use database cache as a shared cache backend
CACHES = {
    "default": {
        "BACKEND": "django.core.cache.backends.db.DatabaseCache",
        "LOCATION": "django_ratelimit_cache_table",
    }
}

# Alternative cache backends (uncomment one):
...
# Option 2: File-based cache (for development)
# CACHES = {
#     "default": {
